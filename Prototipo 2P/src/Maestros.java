...
public class Maestros extends javax.swing.JInternalFrame {
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("insert into maestros1 values(?,?,?,?,?,?)");//Inserta los datos en la tabla alumnos
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("update alumnos1 set nombre_maestro= ?,direccion_maestro = ?,telefono_maestro = ? , email_maestro = ?, estatus_mestro = ? codigo_maestro = "+ Codigo);
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("delete from alumnos1 where codigo_maestro = ?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/siu1", "root", "");
            PreparedStatement pst = cn.prepareStatement("select * from maestros1 where codidgo_mestro = ?");
            pst.setString(1, txtbuscar.getText().trim());
